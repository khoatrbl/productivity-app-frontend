...
function SanctuaryCard({ profile }: SanctuaryCardProps) {
  ...
  return (
    <div className="border-b border-gray-200 bg-[#fcf8f2] px-3 pb-2 pt-[max(0.5rem,env(safe-area-inset-top))] shadow-[0_1.5px_0_0px_rgba(196,181,253,0.15),_1.5px_0_0_0px_rgba(196,181,253,0.15),_-1.5px_0_0_0px_rgba(196,181,253,0.15)]">
      {/* Top row */}
