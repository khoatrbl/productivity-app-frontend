...
function SanctuaryCard({ profile }: SanctuaryCardProps) {
  ...
  return (
    <div className="rounded-b-2xl border border-violet-200 bg-white px-3 pb-2 pt-[max(0.5rem,env(safe-area-inset-top))] shadow-[0_0_0_1.5px_rgba(196,181,253,0.15)]">
      {/* Top row */}
